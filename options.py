...
def get_options(args=None):
    ...
    parser.add_argument(
        "--min_size", type=int, default=20, help="The minimum size of the problem graph"
    )
    parser.add_argument(
        "--max_size", type=int, default=50, help="The maximum size of the problem graph"
    )
    parser.add_argument(
        "--neighbors",
        type=float,
    ...
    # Model/GNN Encoder
    parser.add_argument("--model", default="attention", help="Model: 'attention'/'nar'")
    parser.add_argument(
        "--encoder", default="gnn", help="Graph encoder: 'gat'/'gnn'/'mlp'"
    )
    parser.add_argument(
